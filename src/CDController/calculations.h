...
void ltrOutputs_ex(const std::list<std::shared_ptr<Output>> &outputs,const std::shared_ptr<Mode> &pMode);

void ltrOutputs_dst(const std::list<std::shared_ptr<Output>> &outputs,const std::shared_ptr<Mode> &pMode,const std::list<std::shared_ptr<Pos>> & outputsPos);
