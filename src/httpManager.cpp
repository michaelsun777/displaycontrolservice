...
{   
    ...
    //增，删，改，查窗口列表
    std::function<void(const Request &, Response &)> funcPtrSetScreens = std::bind( &HttpManager::addDlg, this,std::placeholders::_1,std::placeholders::_2);
    std::function<void(const Request &, Response &)> funcPtrSetScreens = std::bind( &HttpManager::delDlg, this,std::placeholders::_1,std::placeholders::_2);
    std::function<void(const Request &, Response &)> funcPtrSetScreens = std::bind( &HttpManager::modifyDlg, this,std::placeholders::_1,std::placeholders::_2);
    std::function<void(const Request &, Response &)> funcPtrSetScreens = std::bind( &HttpManager::searchDlg, this,std::placeholders::_1,std::placeholders::_2);
    std::function<void(const Request &, Response &)> funcPtrSetScreens = std::bind( &HttpManager::getAllDlg, this,std::placeholders::_1,std::placeholders::_2);
